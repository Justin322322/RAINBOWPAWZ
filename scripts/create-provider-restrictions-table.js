...
async function main(){
  ...
  console.log('[provider-restrictions] Connected');
  ...
  console.log('[provider-restrictions] Table ensured');
  await conn.end();
  console.log('[provider-restrictions] Done');
}

main().catch(err => {
  console.error('[provider-restrictions] Error:', err.message);
  process.exit(1);
});
