...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 06, 2025 at 07:54 AM
...
CREATE TABLE `service_packages` (
  ...
  `inclusions` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL COMMENT 'Replaces package_inclusions table' CHECK (json_valid(`inclusions`)),
  `images` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL COMMENT 'Replaces package_images table' CHECK (json_valid(`images`)),
...
CREATE TABLE `service_providers` (
  ...
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  `paymongo_merchant_id` varchar(255) DEFAULT NULL,
...
ALTER TABLE `provider_availability`
  ...
  ADD KEY `idx_provider_availability_date` (`date`);
...
ALTER TABLE `provider_time_slots`
  ...
  ADD KEY `idx_provider_time_slots_datetime` (`date`,`start_time`);
...
ALTER TABLE `reviews`
  ...
  ADD KEY `idx_reviews_provider` (`service_provider_id`),
...
ALTER TABLE `service_providers`
  ...
  ADD KEY `idx_service_providers_status` (`application_status`);
...
ALTER TABLE `user_restrictions`
  ...
  ADD KEY `user_id` (`user_id`),
  ADD KEY `idx_user_restrictions_active` (`is_active`);
...
--
ALTER TABLE `payment_transactions`
  ADD CONSTRAINT `payment_transactions_booking_fk` FOREIGN KEY (`booking_id`) REFERENCES `service_bookings` (`id`) ON DELETE CASCADE;
...
--
ALTER TABLE `provider_availability`
  ADD CONSTRAINT `provider_availability_provider_fk` FOREIGN KEY (`provider_id`) REFERENCES `service_providers` (`provider_id`) ON DELETE CASCADE;

--
-- Constraints for table `provider_time_slots`
--
ALTER TABLE `provider_time_slots`
  ADD CONSTRAINT `provider_time_slots_provider_fk` FOREIGN KEY (`provider_id`) REFERENCES `service_providers` (`provider_id`) ON DELETE CASCADE;

--
-- Constraints for table `refunds`
--
ALTER TABLE `refunds`
  ADD CONSTRAINT `refunds_booking_fk` FOREIGN KEY (`booking_id`) REFERENCES `service_bookings` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `reviews`
--
ALTER TABLE `reviews`
  ADD CONSTRAINT `reviews_booking_fk` FOREIGN KEY (`booking_id`) REFERENCES `service_bookings` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `reviews_provider_fk` FOREIGN KEY (`service_provider_id`) REFERENCES `service_providers` (`provider_id`) ON DELETE CASCADE,
...
--
ALTER TABLE `service_bookings`
  ADD CONSTRAINT `service_bookings_package_fk` FOREIGN KEY (`package_id`) REFERENCES `service_packages` (`package_id`) ON DELETE CASCADE,
  ADD CONSTRAINT `service_bookings_provider_fk` FOREIGN KEY (`provider_id`) REFERENCES `service_providers` (`provider_id`) ON DELETE CASCADE,
  ADD CONSTRAINT `service_bookings_user_fk` FOREIGN KEY (`user_id`) REFERENCES `users` (`user_id`) ON DELETE CASCADE;
