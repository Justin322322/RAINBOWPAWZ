          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="bg-white rounded-lg shadow-[0_4px_16px_rgba(0,0,0,0.1)] p-8 -mt-16 relative z-20">
              ...
              {(isLoading || isLoadingLocation) && serviceProviders.length === 0 && (
                <div className="mb-8 bg-blue-50 border-2 border-blue-300 rounded-xl p-6 flex items-start space-x-4">
                  <svg className="w-8 h-8 text-blue-500 mt-1 flex-shrink-0 animate-pulse" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clipRule="evenodd" />
                  </svg>
                  <div className="flex-1">
                    <p className="text-lg text-blue-900 font-semibold mb-2">Loading service providers...</p>
                    <p className="text-base text-blue-700">This may take a moment on first load. We&apos;re finding the best cremation services near you.</p>
                  </div>
                </div>
              )}
