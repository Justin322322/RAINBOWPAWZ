...
function PackagesPage({ userData }: PackagesPageProps) {
  ...
  const handleCreateSuccess = useCallback(() => {
    // Refresh packages list silently (in background) to show the new package
    fetchPackages(true);
  }, [fetchPackages]);

  const handleEditSuccess = useCallback(() => {
    // Refresh packages list silently (in background) to show updated package data including images
    fetchPackages(true);
  }, [fetchPackages]);
