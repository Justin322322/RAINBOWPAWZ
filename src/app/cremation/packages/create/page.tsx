...
function CreatePackagePage({ userData }: CreatePackagePageProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      showToast(error instanceof Error ? error.message : 'Failed to create package', 'error');
    } finally {
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
          <div className="flex items-center">
            ...
            <div>
              ...
              <p className="text-sm sm:text-base text-gray-600 mt-1">Add a new service package to your offerings</p>
            </div>
          </div>
        </div>
      </div>
